...
class StringAligner():
    ...
    # Constructor
    def __init__(self, first, second, kval, readlen, kmerShiftIndex, initalRepeatShift):
    ...
    def align(self):
        ...
        for index in range(self.readlen - self.kval + 1):
            ...
            if (kmer in self.kmerShiftIndex):
                kmerShiftInRepeat = self.kmerShiftIndex[kmer]
                kmerShiftInFirst = self.initalRepeatShift + kmerShiftInRepeat
